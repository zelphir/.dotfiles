...
nnoremap <silent><C-e> :call <sid>defx_open()<CR>
nnoremap <silent><C-e>f :call <sid>defx_open({ 'find_current_file': v:true })<CR>
let s:default_columns = 'indent:git:icons:filename:type'
